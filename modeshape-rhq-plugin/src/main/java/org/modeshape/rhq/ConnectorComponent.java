...
/**
 * The ModeShape RHQ AS 7 connector component.
 */
public final class ConnectorComponent extends ModeShapeComponent {

    static final String DESCRIPTION = PluginI18n.connectorDescription;
    static final String DISPLAY_NAME = PluginI18n.connectorDisplayName;
    public static final String TYPE = "ModeShapeConnector";
